...
class GridPowerChart extends StatefulWidget {
  ...
  @override
  State<GridPowerChart> createState() => _GridPowerChartState();
}

class _GridPowerChartState extends State<GridPowerChart> {
  int consumption = 100;
  int generation = 200;
  bool isLoading = false;

  Future<int> fetchGridPowerAnalysis() async {
    // start loading
    setState(() {
      isLoading = true;
    });
